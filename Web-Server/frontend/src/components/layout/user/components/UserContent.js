			...
			<div class="container user-container">
				<div class={barAniamtion ? "userpanel-inactive" : "userpanel"}>
					<div className="user-image float-left" >
						...
						<img className="user-profile-img" src="https://cdn2.iconfinder.com/data/icons/ios-7-icons/50/user_male2-512.png" height="100px" />
						<div>
				...
				<div className={isActive ? 'stickbar' : 'stickbar-inactive'}>
					<div className={barAniamtion ? " tag-bar-move" : "tag-bar"}>
						<img className={barAniamtion ? "tag-bar-name-phone" : "tag-bar-name"} src="https://cdn2.iconfinder.com/data/icons/ios-7-icons/50/user_male2-512.png" height="30px" />
						<div className={barAniamtion ? "tag-bar-name-phone" : "tag-bar-name"}> <h5>Imię Nazwisko</h5></div>
						<button onClick={switchContentPosts.bind(this)}>Posty</button>
						<button onClick={switchContentLibrary.bind(this)}>Biblioteczka</button>
